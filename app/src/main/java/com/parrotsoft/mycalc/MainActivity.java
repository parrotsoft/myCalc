...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.EdResult.setInputType(InputType.TYPE_NULL);
    }
        ...
        try {
            switch (v.getId()) {
                ...
                case R.id.btnMas:
                    ...
                    break;
                case R.id.btnIgual:
                    this.textNumber = Double.toString(Math.round(Helpers.eval(this.textNumber) * 100d) / 100d);
                    break;
                case R.id.btnDiv:
                    this.textNumber += "/";
                    break;
            ...
            builder.setMessage("Por favor verificar la operacion digitada")
                    .setTitle("Verificar los valores")
                    .create()
                    .show();
        }
    }
